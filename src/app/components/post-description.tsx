...
export default async function PostDescription({ author, timeAgo, commentsLength, index }: PostProps) {
  return (
          ...
          <div key="1" className="py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <Link className="text-lg text-black hover:underline" href="a">
                  Titulo de post dahora!
                </Link>
